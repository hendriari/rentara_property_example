...
class LocationEventGetCurrentLocation implements LocationEvent {
  const LocationEventGetCurrentLocation();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is LocationEventGetCurrentLocation);
}
