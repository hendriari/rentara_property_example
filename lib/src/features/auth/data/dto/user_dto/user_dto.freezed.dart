...
@override
String toString() {
  return 'UserDto(id: $id, firstName: $firstName, lastName: $lastName, phone: $phone, name: $name, email: $email, emailVerifiedAt: $emailVerifiedAt, updatedAt: $updatedAt)';
}
...
class _UserDto implements UserDto {
  const _UserDto({required this.id, required this.firstName, required this.lastName, required this.phone, required this.name, required this.email, required this.emailVerifiedAt, required this.updatedAt});
